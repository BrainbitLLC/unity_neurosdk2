...
namespace NeuroSDK
{
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void FPGDataCallbackNeuroSmartSensor(IntPtr ptr, [In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] FPGData[] dataArray, [In] int dataSize, IntPtr userData);
	...
	byte ReadIrAmplitudeHeadband(IntPtr ptr, out IrAmplitude amplitudeOut, out OpStatus outStatus);
    byte WriteIrAmplitudeHeadband(IntPtr ptr, IrAmplitude amplitude, out OpStatus outStatus);
    byte ReadRedAmplitudeHeadband(IntPtr ptr, out RedAmplitude amplitudeOu, out OpStatus outStatust);
    byte WriteRedAmplitudeHeadband(IntPtr ptr, RedAmplitude amplitude, out OpStatus outStatus);
        ...
        byte AddFPGDataCallbackNeuroSmart(IntPtr ptr, FPGDataCallbackNeuroSmartSensor callback, out IntPtr handleOut, IntPtr userData, out OpStatus outStatus);
        void RemoveFPGDataCallbackNeuroSmart(IntPtr handle);
    ...
    [DllImport(LibNameOS, CallingConvention = CallingConvention.Cdecl)]
    private static extern byte readIrAmplitudeHeadband(IntPtr ptr, out IrAmplitude amplitudeOut, out OpStatus outStatus);
    [DllImport(LibNameOS, CallingConvention = CallingConvention.Cdecl)]
    private static extern byte writeIrAmplitudeHeadband(IntPtr ptr, IrAmplitude amplitude, out OpStatus outStatus);
    [DllImport(LibNameOS, CallingConvention = CallingConvention.Cdecl)]
    private static extern byte readRedAmplitudeHeadband(IntPtr ptr, out RedAmplitude amplitudeOut, out OpStatus outStatus);
    [DllImport(LibNameOS, CallingConvention = CallingConvention.Cdecl)]
    private static extern byte writeRedAmplitudeHeadband(IntPtr ptr, RedAmplitude amplitude, out OpStatus outStatus);
    [DllImport(LibNameOS, CallingConvention = CallingConvention.Cdecl)]
    ...
    private static extern byte pingNeuroSmart(IntPtr ptr, byte marker, out OpStatus outStatus);
        [DllImport(LibNameOS, CallingConvention = CallingConvention.Cdecl)]
        private static extern byte addFPGDataCallbackNeuroSmart(IntPtr ptr, FPGDataCallbackNeuroSmartSensor callback, out IntPtr handleOut, IntPtr userData, out OpStatus outStatus);
        [DllImport(LibNameOS, CallingConvention = CallingConvention.Cdecl)]
        private static extern void removeFPGDataCallbackNeuroSmart(IntPtr handle);
        ...
        public byte ReadIrAmplitudeHeadband(IntPtr ptr, out IrAmplitude amplitudeOut, out OpStatus outStatus)
        {
            return readIrAmplitudeHeadband(ptr, out amplitudeOut, out outStatus);
        }
        public byte WriteIrAmplitudeHeadband(IntPtr ptr, IrAmplitude amplitude, out OpStatus outStatus)
        {
            return writeIrAmplitudeHeadband(ptr, amplitude, out outStatus);
        }
        public byte ReadRedAmplitudeHeadband(IntPtr ptr, out RedAmplitude amplitudeOut, out OpStatus outStatus)
        {
            return readRedAmplitudeHeadband(ptr, out amplitudeOut, out outStatus);
        }
        public byte WriteRedAmplitudeHeadband(IntPtr ptr, RedAmplitude amplitude, out OpStatus outStatus)
        {
            return writeRedAmplitudeHeadband(ptr, amplitude, out outStatus);
        }
        ...
        public byte AddFPGDataCallbackNeuroSmart(IntPtr ptr, FPGDataCallbackNeuroSmartSensor callback, out IntPtr handleOut, IntPtr userData, out OpStatus outStatus)
        {
            return addFPGDataCallbackNeuroSmart(ptr, callback, out handleOut, userData, out outStatus);
        }
        public void RemoveFPGDataCallbackNeuroSmart(IntPtr handle)
        {
            removeFPGDataCallbackNeuroSmart(handle);
        }
